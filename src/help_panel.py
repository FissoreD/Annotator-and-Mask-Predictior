...
def left_panel(parent):
    ...
    all_img_button = tk.Button(panel_left, text='All images', width=20, command=lambda :(right_panel(panel_right)))
    selected_button = tk.Button(panel_left, text='Selected images', width=20,command=lambda : (right_panel1(panel_right)))
